  ...
  return (
    <div className="descContainer">
      ...
      <div className="description">
        <p>
          Bubble sort is a simple sorting algorithm that was first implemented
          in the early 1950s. The algorithm gets its name from the way smaller
          elements "bubble" to the top of the list, like bubbles rising to the
          surface of a liquid. The concept of the algorithm is simple and is
          often used to teach novice programmers, as it provides a basic
          understanding of sorting algorithms and how they work. Over the years,
          bubble sort has been largely replaced by more efficient sorting
          algorithms, such as quicksort and merge sort, but it remains a useful
          educational tool and is still used in certain specialized applications
          where its simplicity is an advantage.
          <br />
          <br />
          <p>
