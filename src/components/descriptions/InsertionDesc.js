  ...
  return (
    <div>
      ...
      <div className="description">
        <p>
          Insertion sort is a simple sorting algorithm that was first described
          by John W. Tukey in the early 1950s. It is based on the idea of
          building up a sorted list one element at a time, by inserting each
          element into its proper position in the sorted list. This algorithm is
          often used as an introduction to sorting algorithms in computer
          science education. Insertion sort is also used in practice when the
          data being sorted is small, nearly sorted, or when the number of
          writes is a concern, as it makes very few writes compared to other
          sorting algorithms.
          <p>
