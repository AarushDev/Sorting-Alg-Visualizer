    ...
    <div>
      ...
      <div className="description">
        <p>
          ...
          von Neumann in 1945. It works by recursively dividing the unsorted
          list into smaller sublists until each sublist has only one element,
          and then merging these sublists back into one sorted list. Merge sort
          is considered to be one of the most efficient sorting algorithms, with
          a time complexity of O(n log n). It is widely used in computer
          science, particularly in the field of data analysis and large-scale
          data processing. Despite its efficiency, merge sort can require a
          large amount of memory compared to other sorting algorithms, making it
          less suitable for systems with limited memory resources.
          <p>
