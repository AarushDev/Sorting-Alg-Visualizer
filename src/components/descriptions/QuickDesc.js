    ...
    <div>
      ...
      <div className="description">
        <p>
          ...
          partitioning the other elements into two sublists, according to
          whether they are less than or greater than the pivot. The sublists are
          then sorted recursively, until the list is fully sorted. Quick sort is
          considered to be one of the most efficient sorting algorithms, with a
          time complexity of O(n log n) on average. It is widely used in
          computer science, particularly in the field of data analysis and
          large-scale data processing. Quick sort is often faster than merge
          sort in practice, due to its smaller memory overhead and efficient
          ...
          <p>
            ...
            elements into two sublists, according to whether they are less than
            or greater than the pivot. The sublists are then sorted recursively
            until the list is fully sorted.
          </p>
          <p>
            <strong>Time Complexity:</strong> O(n log n) on average, O(n^2) in
            the worst case.
          </p>
          <p>
            <strong>Space Complexity:</strong> O(log n) in the average case,
            O(n) in the worst case (for the worst case scenario, an in-place
            sorting algorithm with O(1) space complexity is required).
          </p>
          <h3>Algorithm:</h3>
          <ol>
            <li>Select a pivot element from the list.</li>
            <li>
              Partition the other elements into two sublists, according to
